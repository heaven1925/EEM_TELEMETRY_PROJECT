...
#include "sx1262__public.h"


/*
 * SX1262 stdint typedefs
 */
typedef 	uint8_t			    radio_uint8_t   ;
typedef 	uint16_t		    radio_uint16_t  ;
typedef 	uint32_t		    radio_uint32_t  ;
typedef 	uint64_t		    radio_uint64_t  ;
typedef 	int8_t			    radio_int8_t    ;
typedef 	int16_t		        radio_int16_t   ;
typedef 	int32_t		        radio_int32_t   ;
typedef 	int64_t		        radio_int64_t   ;
typedef 	double			    radio_double    ;
typedef 	float			    radio_float     ;

typedef		radio_uint8_t		radio_size_t	;
...
struct Radio_s
{
     ...
     */
    radio_err_t   ( *Init )( RadioEvents_t *events );
    /*!
     ...
     */
    radio_err_t   ( *SetChannel )( uint32_t freq );
    /*!
